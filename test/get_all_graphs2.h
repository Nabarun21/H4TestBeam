...
//void get_all_graphs2(string fdat,double shift_x,double  shift_y,TMultiGraph* Mg[8],int s){
void get_all_graphs2(string fdat,double shift_x,double  shift_y,TH2F* Mg[8],int s){
...
cout<<"scales"<<frontx<<" "<<backx<<" "<<fronty<<" "<<backy<<endl;
  ...
  //X
  extract_shift_Tgraph2(n_pos_X1,n_calo_Xf,frontx,shift_x,shift_y,1,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_X2,n_calo_Xf,frontx,shift_x,shift_y,2,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_X1,n_calo_Xb,backx,shift_x,shift_y,3,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_X2,n_calo_Xb,backx,shift_x,shift_y,4,Mg,s,run_num);
  

  //Y
  extract_shift_Tgraph2(n_pos_Y1,n_calo_Yf,fronty,shift_x,shift_y,5,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_Y2,n_calo_Yf,fronty,shift_x,shift_y,6,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_Y1,n_calo_Yb,backy,shift_x,shift_y,7,Mg,s,run_num);
  extract_shift_Tgraph2(n_pos_Y2,n_calo_Yb,backy,shift_x,shift_y,8,Mg,s,run_num);
